    ...
    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-password">旧密码</label>
                <div class="col-sm-10">
                    <input name="password" value="" placeholder="密码" id="input-old-password" class="form-control" type="password">
                </div>
            </div>
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-password">新密码</label>
                <div class="col-sm-10">
                    <input name="password" value="" placeholder="密码" id="input-new-password" class="form-control" type="password">
                </div>
            </div>
            <div class="form-group required">
