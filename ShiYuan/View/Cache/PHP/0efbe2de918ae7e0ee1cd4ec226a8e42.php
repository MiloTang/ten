...
<h2>地址管理</h2>
 <legend>地址详情</legend>
 <button type="button" class="btn btn-danger pull-right">删除地址</button>
 <div class="well">
     <h4>默认收货地址</h4>
     <p>收货人：
         温妮
 ...
 <button type="button" class="btn btn-danger">新增地址</button>
            <div class="text-center"><a  href="http://localhost/member">返回</a></div>
 </div>
 </div>
 </div>
